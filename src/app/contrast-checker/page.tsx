    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">Contrast Checker</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 sm:p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Colors</h2>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-12 h-12 rounded-lg border-2 border-gray-300 dark:border-gray-600 cursor-pointer transition-transform hover:scale-105 touch-target"
                ...
                <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg px-3 py-2 flex-1">
                  ...
                  <input
                    ...
                    maxLength={6}
                    className="bg-transparent border-none outline-none font-mono uppercase flex-1 ml-1 text-gray-900 dark:text-white"
                  />
                </div>
              </div>
            ...
            <div className="flex justify-center my-4">
              <button
                onClick={swapColors}
                className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors touch-target"
                title="Swap colors"
              >
            ...
            {!contrast.aa.normal && (
              <button
                onClick={suggestFg}
                className="mt-6 w-full py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors touch-target"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 text-center">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Contrast Ratio</p>
              <p className="text-5xl sm:text-6xl font-bold text-gray-900 dark:text-white">{contrast.ratio}</p>
              <p className="text-xl sm:text-2xl text-gray-400">:1</p>
              <div className="mt-4">
                <span
            ...
            {/* WCAG levels */}
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 sm:p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">WCAG Compliance</h3>
        ...
        <div className="mt-8 sm:mt-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-6">Preview</h2>
        ...
        {/* Guidelines */}
        <div className="mt-8 sm:mt-12 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-6">WCAG Guidelines</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Level AA (Minimum)</h3>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-gray-900 dark:text-white">4.5:1</strong> for normal text (under 18pt or 14pt bold)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-gray-900 dark:text-white">3:1</strong> for large text (18pt+ or 14pt+ bold)</span>
                </li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Level AAA (Enhanced)</h3>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-gray-900 dark:text-white">7:1</strong> for normal text</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span><strong className="text-gray-900 dark:text-white">4.5:1</strong> for large text</span>
                </li>
              </ul>
            </div>
          </div>
